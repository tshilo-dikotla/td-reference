"""
Django settings for td_reference project.
...
ROOT_URLCONF = 'td_reference.urls'
...
WSGI_APPLICATION = 'td_reference.wsgi.application'
...
STATIC_ROOT = os.path.join(BASE_DIR, 'td_reference', 'static')
